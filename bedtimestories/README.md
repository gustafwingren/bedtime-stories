...
To update the database use this command from the Web project folder (replace `bedtimestories` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../bedtimestories.Infrastructure/bedtimestories.Infrastructure.csproj -s bedtimestories.Web.csproj
```
